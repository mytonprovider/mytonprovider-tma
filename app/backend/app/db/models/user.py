...
class UserModel(BaseModel):
    ...
    names: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict, server_default="{}")
    ...
    state: Mapped[str] = mapped_column(String(16), nullable=False, default="member", server_default="member")
